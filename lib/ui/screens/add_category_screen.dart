...
class _AddCategoryScreenState extends ConsumerState<AddCategoryScreen> {
  ...
  void _saveCategory() async {
    if (_formKey.currentState!.validate()) {
      ...
      final colorString = '#'
              '${((_selectedColor.r * 255.0).round() & 0xff).toRadixString(16).padLeft(2, '0')}'
              '${((_selectedColor.g * 255.0).round() & 0xff).toRadixString(16).padLeft(2, '0')}'
              '${((_selectedColor.b * 255.0).round() & 0xff).toRadixString(16).padLeft(2, '0')}'
          .toUpperCase();
