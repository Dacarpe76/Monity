...
import 'package:monity/ui/screens/manage_credits_screen.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              IconButton(
                icon:
                    Icon(showAmounts ? Icons.visibility : Icons.visibility_off),
                onPressed: () {
              ...
              IconButton(
                ...
                tooltip: 'Gestionar Créditos',
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => const ManageCreditsScreen()),
                  );
                },
              ),
            ],
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text(
                                    'Aún no tienes cuentas. ¡Crea una para empezar a gestionar tus finanzas!',
                                    textAlign: TextAlign.center,
                                  ),
                                  ...
                                  ElevatedButton.icon(
                                    icon: const Icon(Icons.add),
                                    label:
                                        const Text('Crear mi primera cuenta'),
...
class _CreditListTile extends StatefulWidget {
  ...
  const _CreditListTile(
      {required this.credit, required this.showAmounts, super.key});
